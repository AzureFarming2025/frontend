  ...
  return (
    <div className="col-span-full xl:col-span-6 bg-white shadow-xs rounded-xl">
      ...
      <div className="p-3">
        ...
        {/* "Today" group */}
        <div>
          <header className="text-xs uppercase text-gray-400 bg-gray-50 rounded-xs font-semibold p-2">Today</header>
          <ul className="my-1">
            {/* Item */}
        ...
        {/* "Yesterday" group */}
        <div>
          <header className="text-xs uppercase text-gray-400  bg-gray-50  rounded-xs font-semibold p-2">Yesterday</header>
          <ul className="my-1">
            {/* Item */}
            <li className="flex px-2">
